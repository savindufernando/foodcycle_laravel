<header class="relative z-10 w-full"> 
    <div class="flex items-center justify-between w-full px-6 mx-auto bg-white backdrop-blur-md">
        ...
        <nav class="hidden space-x-6 md:flex font-mono">
            ...
            <div class="relative">
                ...
                <div id="servicesMenu" class="absolute hidden w-56 mt-2 bg-white rounded-md shadow-lg">
                    ...
                    <a href="{{ route('consultant.publicInfo') }}"  class="block px-4 py-2 text-sm text-gray-800 transition hover:bg-gray-100">Join with us</a>
            ...
            <div class="relative">
                ...
                <div id="educationMenu" class="absolute hidden w-56 mt-2 bg-white rounded-md shadow-lg">
                    ...
                    <a href="{{ route('newsletter.form') }}" class="block px-4 py-2 text-sm text-gray-800 transition hover:bg-gray-100">Newsletter</a>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative items-center hidden space-x-4 md:flex navIcon">
                ...
                <a href="{{ route('cart.index') }}"><i class="fas fa-shopping-cart hover:text-green-800"></i></a>
    ...
    <div id="mobileMenu" class="hidden p-4 bg-gray-100 md:hidden">
        <a href="/" class="block py-2 {{ request()->is('/') ? 'text-green-500' : 'text-black' }}">Home</a>
        <a href="#" class="block py-2">About</a>
        <a href="/shop" class="block py-2 {{ request()->is('shop') ? 'text-green-500' : 'text-black' }}">Shop</a>
        <a href="/donation" class="block py-2 {{ request()->is('donation') ? 'text-green-500' : 'text-black' }}">Donation</a>
        ...
        <a href="{{ route('blogs.index') }}" class="block py-2">Blog</a>
