...
<body class="bg-white-100">
    ...
    Already have an account? 
                <a href="{{ route('consultant.loginForm') }}" class="text-green-600 hover:underline">Log in</a>
            </p>
    <div class="container mx-auto mt-10 p-8 bg-white shadow-lg rounded-xl max-w-4xl">
        ...
        <form action="{{ route('consultant.register') }}" method="POST" id="registration-form" class="space-y-6">
            @csrf
            ...
            <div id="step-1" class="step">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="education" name="education" value="{{ old('education') }}" placeholder="Enter your education" 
                        class="w-full border border-gray-300 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                    @error('education')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="qualifications" name="qualifications" value="{{ old('qualifications') }}" placeholder="Enter your qualifications" 
                        class="w-full border border-gray-300 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="contact_no" name="contact_no" value="{{ old('contact_no') }}" placeholder="Enter your contact number" 
                        class="w-full border border-gray-300 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                    @error('contact_no')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
