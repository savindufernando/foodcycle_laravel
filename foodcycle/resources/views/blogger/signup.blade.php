        ...
        <div class="w-full max-w-3xl p-8 bg-white rounded-lg shadow-md">
            ...
            <div class="text-right">
                <p class="text-gray-700">
                    ...
                    <a href="{{ route('blogger.login') }}" class="font-medium text-green-500 hover:text-green-700">
                        Log in
                    </a>
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('blogger.signup') }}" enctype="multipart/form-data">
                @csrf
