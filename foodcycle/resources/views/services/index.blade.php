...
@include('layouts.header')
    <!-- Services Section -->
    <div class="relative bg-cover bg-center h-96" style="background-image: url('{{ asset('panel/image/cons.png') }}');">
    </div>
    ...
    <div class="container mx-auto mt-10 p-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mt-16">
            <div class="flex items-center space-x-6 p-8 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <img src="{{ asset('panel/image/Feasibility.jpg') }}" alt="Feasibility Icon" class="w-20 h-20 object-cover">
                <div>
            ...
            <div class="flex items-center space-x-6 p-8 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <img src="{{ asset('panel/image/farmdesign.jpg') }}" alt="Farm Designs Icon" class="w-20 h-20 object-cover">
                <div>
            ...
            <div class="flex items-center space-x-6 p-8 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <img src="{{ asset('panel/image/local.webp') }}" alt="Local Food Planning Icon" class="w-20 h-20 object-cover">
                <div>
            ...
            <div class="flex items-center space-x-6 p-8 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <img src="{{ asset('panel/image/due.jpg') }}" alt="Due Diligence Icon" class="w-20 h-20 object-cover">
                <div>
            ...
            <div class="flex items-center space-x-6 p-8 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <img src="{{ asset('panel/image/sus.webp') }}" alt="Sustainability Consulting Icon" class="w-20 h-20 object-cover">
                <div>
            ...
            <div class="flex items-center space-x-6 p-8 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <img src="{{ asset('panel/image/agr.webp') }}" alt="AgriTech Implementation Icon" class="w-20 h-20 object-cover">
                <div>
            ...
            <div class="flex items-center space-x-6 p-8 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <img src="{{ asset('panel/image/pr.webp') }}" alt="Project Management Icon" class="w-20 h-20 object-cover">
                <div>
            ...
            <div class="flex items-center space-x-6 p-8 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <img src="{{ asset('panel/image/ed.webp') }}" alt="Education & Workshops Icon" class="w-20 h-20 object-cover">
                <div>
    ...
    <div class="container mx-auto mt-16 p-8 bg-white shadow-lg rounded-xl max-w-4xl">
        ...
        <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="country" name="country" placeholder="Enter your country" value="{{ old('country') }}"
                    class="w-full border border-gray-300 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="company_description" name="company_description" placeholder="Describe your company"
                    class="w-full border border-gray-300 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('company_description') }}</textarea>
            </div>

            <div class="mb-4">
                <label for="heard_about_us" class="block font-medium mb-1">How Did You Hear About Us?</label>
                <input type="text" id="heard_about_us" name="heard_about_us" placeholder="e.g., Social Media, Friend" value="{{ old('heard_about_us') }}"
                    class="w-full border border-gray-300 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
...
<div class="mb-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div>
            <label><input type="checkbox" name="services_of_interest[]" value="Feasibility" {{ in_array('Feasibility', old('services_of_interest', [])) ? 'checked' : '' }}> Feasibility</label>
        </div>
        <div>
            <label><input type="checkbox" name="services_of_interest[]" value="Farm Designs" {{ in_array('Farm Designs', old('services_of_interest', [])) ? 'checked' : '' }}> Farm Designs</label>
        </div>
        <div>
            <label><input type="checkbox" name="services_of_interest[]" value="Local Food Planning" {{ in_array('Local Food Planning', old('services_of_interest', [])) ? 'checked' : '' }}> Local Food Planning</label>
        </div>
        <div>
            <label><input type="checkbox" name="services_of_interest[]" value="Due Diligence" {{ in_array('Due Diligence', old('services_of_interest', [])) ? 'checked' : '' }}> Due Diligence</label>
        </div>
        <div>
            <label><input type="checkbox" name="services_of_interest[]" value="Sustainability and Environmental Consulting" {{ in_array('Sustainability and Environmental Consulting', old('services_of_interest', [])) ? 'checked' : '' }}> Sustainability and Environmental Consulting</label>
        </div>
        <div>
            <label><input type="checkbox" name="services_of_interest[]" value="Agricultural Technology Implementation" {{ in_array('Agricultural Technology Implementation', old('services_of_interest', [])) ? 'checked' : '' }}> Agricultural Technology Implementation</label>
        </div>
        <div>
            <label><input type="checkbox" name="services_of_interest[]" value="Project Management" {{ in_array('Project Management', old('services_of_interest', [])) ? 'checked' : '' }}> Project Management</label>
        </div>
        <div>
            <label><input type="checkbox" name="services_of_interest[]" value="Education and Workshops" {{ in_array('Education and Workshops', old('services_of_interest', [])) ? 'checked' : '' }}> Education and Workshops</label>
        </div>
    </div>
</div>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="project_location" name="project_location" placeholder="Enter project location" value="{{ old('project_location') }}"
                    class="w-full border border-gray-300 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="project_description" name="project_description" placeholder="Describe your project"
                    class="w-full border border-gray-300 px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('project_description') }}</textarea>
            </div>
