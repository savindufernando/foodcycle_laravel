...
<main class="flex-1 p-6 ml-64 overflow-y-auto">
    ...
    <div id="teacherModal" class="fixed inset-0 flex items-center justify-center hidden bg-gray-900 bg-opacity-50">
        <div class="w-1/3 p-6 bg-white rounded shadow-lg">
            ...
            <!-- Add Admin Form -->
            <form id="addTeacherForm" action="{{ route('teacher.accounts.store') }}" method="POST">
                @csrf
                <div class="mb-4">
                ...
                @foreach ($teachers as $teacher)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2 border">
                            <!-- Delete Button -->
                            <form action="{{ route('teacher.accounts.destroy', $teacher->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
