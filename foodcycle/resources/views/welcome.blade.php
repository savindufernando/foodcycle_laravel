...
<body>
     ...
     <header class="relative z-10 w-full"> 
        <div class="flex items-center justify-between w-full px-6 mx-auto bg-white backdrop-blur-md">
            ...
            <nav class="relative hidden space-x-6 md:flex">
                ...
                <a href="" class="font-semibold text-black hover:text-green-800">Shop</a>
                ...
                <div class="relative items-center hidden space-x-4 md:flex navIcon">
                    ...
                    <div class="relative dropdown">
                        ...
                        <div id="dropdown-menu1" class="absolute right-0 hidden w-48 mt-2 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="dropdown-nav">
                            <span class="block px-4 py-2 font-serif text-lg text-red-500">Hi, Hirusha</span>
        ...
        <div id="mobileMenu" class="hidden p-4 bg-gray-100 md:hidden">
            ...
            <a href="#" class="block py-2 text-black">Shop</a>
    ...
    <!-- Main Section -->
    <section class="relative items-center bg-no-repeat bg-cover h-[30rem]" style="background-image: url('{{ asset('panel/image/banner.jpg') }}')">
        <div class="flex items-center justify-start pl-6 h-5/6 lg:pl-28">
            <div class="text-left text-black">
                <h1 class="mb-1 text-xl font-bold">Reduce Food Waste,</h1>
                <h2 class="mb-12 text-4xl font-bold">Buy Fresh Leftovers at Great Prices</h2>
                <a href="#" class="px-6 py-3 text-white bg-green-500 rounded hover:bg-green-600">Shop Now</a>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 ">
        <div class="grid items-center grid-cols-1 gap-8 mx-auto max-w-7xl md:grid-cols-2">
            <div class="p-4">
                <img src="{{ asset('panel/image/market.jpg') }}" alt="About Us Image" class="w-full h-auto rounded-lg shadow-lg">
            </div>
    ...
    <section class="w-full mx-auto text-center"> 
        ...
        <div class="flex items-center justify-center space-x-56">
            <div class="w-40">
                <img src="{{ asset('panel/image/Partner1.jpeg') }}" alt="Finlays Logo" class="mx-auto mb-4"> 
            </div>
            <div class="w-36">
                <img src="{{ asset('panel/image/Partner2.jpeg') }}" alt="Logicare Logo" class="mx-auto mb-4"> 
            </div>
        </div>
    </section>

    <!-- Contact Section -->
    <section class="py-10 text-center bg-slate-100">
        <h2 class="mb-8 text-2xl font-semibold text-green-600">Contact Us</h2>
        <div class="grid max-w-4xl grid-cols-1 mx-auto gap-9 sm:grid-cols-2">
            <!-- Address Box 1 -->
    ...
    <!-- Footer -->
    <footer class="py-10 text-gray-300 bg-gray-700 rounded-t-3xl">
