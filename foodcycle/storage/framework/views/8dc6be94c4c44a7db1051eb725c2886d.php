  ...
  <main class="py-12">
    <div class="px-6 mx-auto max-w-7xl">
      ...
      <div class="grid items-center gap-8 mb-16 lg:grid-cols-2">
        ...
        <div>
            <img src="<?php echo e(asset('panel/image/ServiceBanner.jpg')); ?>" alt="Who We Are" class="rounded-lg shadow-md">
        </div>
      </div>
      ...
      <section id="get-involved" class="mt-16">
        ...
        <div class="grid gap-8 lg:grid-cols-2">
          ...
          <div class="p-6 bg-white rounded-lg shadow-md">
            ...
            <a href="<?php echo e(route('service.delivery')); ?>" class="inline-block px-4 py-2 mt-4 text-white transition bg-green-500 rounded-lg hover:bg-green-600">
          ...
          <div class="p-6 bg-white rounded-lg shadow-md">
            ...
            <a href="<?php echo e(route('service.storage')); ?>" class="inline-block px-4 py-2 mt-4 text-white transition bg-green-500 rounded-lg hover:bg-green-600">
...
<?php /**PATH C:\Users\savin\Desktop\foodcycle\resources\views/service/index.blade.php ENDPATH**/ ?>