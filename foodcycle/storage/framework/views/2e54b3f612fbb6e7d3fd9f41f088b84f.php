    ...
    <div class="flex flex-1 pt-24">
        ...
        <aside class="sidebar w-64 bg-green-50 shadow">
            <nav class="p-6 space-y-4">
                ...
                <a href="<?php echo e(route('teacher.newsletter.form')); ?>" class="flex items-center text-gray-600 hover:text-green-600">
        ...
        <main class="flex-1 p-8">
            ...
            <!-- Form -->
            <form action="<?php echo e(route('teacher.newsletter.send')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $subscribers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscriber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-center">
                                <td class="border border-gray-300 p-3"><?php echo e($subscriber->id); ?></td>
                                <td class="border border-gray-300 p-3"><?php echo e($subscriber->email); ?></td>
                                <td class="border border-gray-300 p-3"><?php echo e($subscriber->created_at); ?></td>
                            </tr>
...
<?php /**PATH C:\Users\savin\Desktop\foodcycle\resources\views/teacher/newsletter.blade.php ENDPATH**/ ?>