...
<body class="bg-gray-100">
    ...
    <div class="header flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
            <?php if(auth()->guard('blogger')->check()): ?>
                <div class="relative">
                    ...
                    <div id="dropdownMenu" class="absolute hidden right-0 w-48 mt-2 bg-white rounded-lg shadow-lg">
                        <a href="<?php echo e(route('blogger.dashboard')); ?>" class="block px-4 py-2">Dashboard</a>
                        <a href="<?php echo e(route('blogger.profile')); ?>" class="block px-4 py-2">Profile</a>
            ...
            <?php else: ?>
                <a href="<?php echo e(route('blogger.login')); ?>" class="px-4 py-1.5 bg-green-500 text-white rounded-lg hover:bg-green-700">
                    Be a Blogger
                </a>
            <?php endif; ?>
        </div>
    ...
    <div class="content">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <!-- Search Bar -->
            <form action="<?php echo e(route('blogs.index')); ?>" method="GET" class="flex items-center">
                <input 
                    type="text" 
                    name="search" 
            ...
            <a href="<?php echo e(route('blogs.create')); ?>" class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-700 ml-4">
                Create New Post
            </a>
        </div>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                        ...
                        <?php endif; ?>
                        <div class="p-4">
                            <h2 class="text-lg font-semibold"><?php echo e($blog->title); ?></h2>
                            <p class="text-sm mt-2"><?php echo e(Str::limit(strip_tags($blog->content), 80)); ?></p>
                            <div class="mt-4 flex justify-between items-center">
                                <a href="<?php echo e(route('blogs.show', $blog->id)); ?>" class="text-blue-500 hover:underline">Read More</a>
                                <span class="text-xs text-gray-500">By: <?php echo e($blog->blogger->name); ?> on <?php echo e($blog->created_at->format('M d, Y')); ?></span>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\savin\Desktop\foodcycle\resources\views/blogger/dashboard.blade.php ENDPATH**/ ?>