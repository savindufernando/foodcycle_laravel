                    ...
                    <div class="relative dropdown">
                        ...
                        <div id="dropdown-menu1" class="absolute right-0 hidden w-48 mt-2 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="dropdown-nav">
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <form id="logout-form" action="<?php echo e(route('teacher.logout')); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\Users\savin\Desktop\foodcycle\resources\views/teacher/layouts/sidebar.blade.php ENDPATH**/ ?>