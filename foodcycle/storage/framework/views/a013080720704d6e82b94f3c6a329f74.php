...
<body class="bg-gray-100">
    <div class="flex items-center justify-center min-h-screen">
        <div class="w-full max-w-sm p-6 bg-white rounded-lg shadow-lg">
            ...
            <!-- Login Form -->
            <form action="<?php echo e(route('consultant.login')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <!-- Email Field -->
                <div>
            ...
            <p class="mt-6 text-center text-gray-600">
                ...
                <a href="<?php echo e(route('consultant.registerForm')); ?>" class="text-green-600 hover:underline">Register here</a>
            </p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\savin\Desktop\foodcycle\resources\views/consultant/login.blade.php ENDPATH**/ ?>