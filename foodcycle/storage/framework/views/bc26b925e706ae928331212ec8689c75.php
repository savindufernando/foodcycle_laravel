...
<body class="bg-gray-50 text-gray-800 font-sans">
  ...
  <!-- Banner Section -->
  <section class="relative bg-cover bg-center h-96" style="background-image: url('<?php echo e(asset('panel/image/donationBanner.jpg')); ?>');">
...
<section id="registration_section" class="bg-gradient-to-b from-green-50 to-gray-50 py-16 px-6">
  <div class="container mx-auto text-center">
    ...
    <div class="flex justify-center space-x-4">
      <a href="<?php echo e(route('donation.signup')); ?>" class="bg-green-600 text-white px-8 py-4 rounded-lg font-bold shadow-md hover:bg-green-700 transition-all duration-300">
        Signup
      </a>
      <a href="<?php echo e(route('donation.login')); ?>" class="bg-white border border-green-600 text-green-600 px-8 py-4 rounded-lg font-bold shadow-md hover:bg-green-100 transition-all duration-300">
        Login
      </a>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div class="overflow-x-auto shadow-lg rounded-lg bg-white">
        <table class="table-auto w-full text-left border-collapse">
          ...
          <tbody>
            <?php $__currentLoopData = $foodRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="odd:bg-gray-50 even:bg-gray-100 hover:bg-green-50">
              <td class="px-6 py-4"><?php echo e($request->organization_name); ?></td>
              <td class="px-6 py-4"><?php echo e($request->Org_location); ?></td>
              <td class="px-6 py-4"><?php echo e($request->type); ?></td>
              <td class="px-6 py-4"><?php echo e($request->title); ?></td>
              <td class="px-6 py-4"><?php echo e($request->purpose); ?></td>
              <td class="px-6 py-4"><?php echo e($request->beneficiaries); ?></td>
              <td class="px-6 py-4 text-center">
                <a href="<?php echo e(route('donation.donationForm', ['id' => $request->id])); ?>" class="bg-green-600 text-white px-4 py-2 rounded-lg font-semibold shadow-md hover:bg-green-700 transition-all text-sm">
                  Donate
                </a>
              </td>
            </tr>
...
<?php /**PATH C:\Users\savin\Desktop\foodcycle\resources\views/Donation/index.blade.php ENDPATH**/ ?>