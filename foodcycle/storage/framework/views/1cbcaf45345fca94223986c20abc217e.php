    ...
    <header class="fixed top-0 z-10 w-full bg-white shadow">
        <div class="flex items-center justify-between w-full px-6 mx-auto bg-white backdrop-blur-md">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="<?php echo e(route('admin.register')); ?>" class="px-4 py-2 text-white bg-green-600 rounded">Seller</a>
                <?php endif; ?>
                    ...
                    <div class="relative dropdown">
                        ...
                        <div id="dropdown-menu1" class="absolute right-0 hidden w-48 mt-2 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="dropdown-nav">
                            <?php if(auth()->guard()->check()): ?>
                                ...
                                <a href="<?php echo e(route('admin.profile.edit')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Profile</a>
    ...
    <div class="flex flex-1 pt-24">
        ...
        <aside class="fixed top-16 left-0 flex flex-col justify-between w-64 h-[calc(100vh-7rem)] bg-white shadow pt-10">
            ...
            <nav class="p-6 space-y-4">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center text-gray-600 hover:text-green-600">
                    <i class="mr-3 fas fa-home"></i> Dashboard
                </a>
                <a href="<?php echo e(route('admin.viewproduct')); ?>" class="flex items-center text-gray-600 hover:text-green-600">
                ...
                <a href="<?php echo e(route('admin.expiredproducts')); ?>" class="flex items-center text-gray-600 hover:text-green-600">
        ...
        </aside><?php /**PATH C:\Users\savin\Desktop\foodcycle\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>